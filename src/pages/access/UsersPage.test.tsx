  ...
  return render(
    <QueryClientProvider client={client}>
      <MemoryRouter initialEntries={[path]}>
        <Routes>
          <Route path="/app/access/users" element={<UsersPage />} />
          <Route path="/app/access/users/new" element={<UsersPage />} />
          <Route path="/app/access/users/:userId/edit" element={<UsersPage />} />
        </Routes>
      </MemoryRouter>
    </QueryClientProvider>,
  )
